...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        float horizontal = 20f; // 이 변수와
        float vertical = 20f; // 이 변수를 사용해야 합니다.
    Input.GetAxis.float horizontal = 20f;
    Input.GetAxis.float vertical = 20f;
    #region 건드리면 작동 안 됨
    movement.Set(horizontal, 0f, vertical);
        ...
        bool hasHorizontalInput = !Mathf.Approximately(horizontal, 20f);
        bool hasVerticalInput = !Mathf.Approximately(vertical, 20f);
